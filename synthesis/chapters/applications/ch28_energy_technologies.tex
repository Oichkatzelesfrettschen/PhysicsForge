...
Current state-of-the-art (2025) nanofabrication can achieve $\sim 5$ nm resolution~\cite{NanoFab2024}, requiring further advances for full-scale fractal devices.
...
\input{modules/equations/eq_aether_plasmoid_thrust}
