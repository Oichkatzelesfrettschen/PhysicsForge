...
\input{modules/equations/eq_scalar_general_energy_extraction}
...
\input{modules/equations/eq_scalar_casimir_scalar_modulation}
...
% DUPLICATE REMOVED: eq_scalar_exotic_matter_density already included in ch30 line 198
% \input{modules/equations/eq_scalar_exotic_matter_density}
...
\input{modules/equations/eq_scalar_plasmoid_thrust}
...
\input{modules/equations/eq_scalar_black_hole_energy_harvesting}
...
\input{modules/equations/eq_scalar_black_hole_entropy}
...
\input{modules/equations/eq_scalar_cold_plasma_energy_transfer}
...
\input{modules/equations/eq_scalar_plasma_wave_zpe_coupling}
...
\input{modules/equations/eq_scalar_coupled_plasma_scalar_stabilization}
