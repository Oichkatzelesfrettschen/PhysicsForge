\chapter{Genesis Origami Dimensions: Dimensional Folding Mechanics}
...
% Equation Modules
%------------------------------------------------------------------------------
\input{modules/equations/eq_genesis_foldmerge_operator}
\input{modules/equations/eq_genesis_dimensional_folding}
\input{modules/equations/eq_genesis_kk_projection}
\input{modules/equations/eq_genesis_folding_topology}
