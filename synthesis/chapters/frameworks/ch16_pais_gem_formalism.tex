...
tensor:
\input{modules/equations/eq_pais_gem_field_tensor.tex}
...
\input{modules/equations/eq_pais_gem_maxwell_gauss.tex}
\input{modules/equations/eq_pais_gem_maxwell_ampere.tex}
...
\input{modules/equations/eq_pais_gem_coupling.tex}
...
\input{modules/equations/eq_pais_field_equations}
...
GEM sources:
\input{modules/equations/eq_pais_scalar_gem_coupling.tex}
...
\input{modules/equations/eq_pais_fifth_force.tex}
...
\input{modules/equations/eq_aether_gem_coupling_force}
...
\input{modules/equations/eq_aether_modified_strong_force}
...
\input{modules/equations/eq_aether_modified_weak_potential}
