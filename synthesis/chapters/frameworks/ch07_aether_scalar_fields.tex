...
\chapter{Scalar Field Overview: Vacuum Mediation Mechanisms}
...
\input{modules/equations/eq_scalar_scalar_field_governing.tex}
...
\input{modules/equations/eq_scalar_scalar_field_potential.tex}
...
\input{modules/equations/eq_scalar_scalar_zpe_coupling.tex}
...
\input{modules/equations/eq_scalar_crystalline_lattice.tex}
...
\input{modules/equations/eq_scalar_dimensional_projection.tex}
...
\input{modules/equations/eq_scalar_time_crystal.tex}
...
\begin{itemize}
  ...
  \item Deionized water (18.2 M$\Omega\cdot$cm resistivity)
