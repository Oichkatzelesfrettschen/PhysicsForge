...
\input{modules/equations/eq_gem_gravitational_force}
...
\input{modules/equations/eq_gem_strong_nuclear_force}
...
\input{modules/equations/eq_gem_superforce_gradient}
...
\input{modules/equations/eq_gem_tensor_gauge_theory}
...
\input{modules/equations/eq_gem_pais_superforce}
\input{modules/equations/eq_gem_vacuum_bernoulli}
...
\begin{figure}[h!]
  ...
  \caption{Diagram from the Pais patent for an inertia reduction device.}
