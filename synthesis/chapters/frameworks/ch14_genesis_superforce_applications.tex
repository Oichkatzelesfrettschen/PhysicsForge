\chapter{Genesis Superforce Applications: String Theory and Cosmology}
...
% Equation Modules
%------------------------------------------------------------------------------
\input{modules/equations/eq_genesis_string_worldsheet}
\input{modules/equations/eq_genesis_susy_breaking}
\input{modules/equations/eq_genesis_inflation}
\input{modules/equations/eq_genesis_quantum_geometry}
\input{modules/equations/eq_genesis_spin_network}
