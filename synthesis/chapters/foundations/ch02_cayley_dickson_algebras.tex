...
% \begin{figure}[h]
%   \centering
  \input{modules/figures/fig_cayley_dickson_tree}
...
\begin{equation}
  ...
  \label{eq:cayley:recursion}
  \label{eq:cayley:doubling-formula}
  \eqtag{M}{MATH}{T}
\end{equation}
...
\input{modules/equations/eq_cayley_dickson_multiplication.tex}
