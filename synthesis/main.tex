...
\input{chapters/foundations/part1_foundations}

\part{Theoretical Frameworks}\label{part:frameworks}
\input{chapters/frameworks/part2_frameworks}

\part{Unified Synthesis}\label{part:unification}
\input{chapters/unification/part3_unification}

\part{Experimental Validation}\label{part:experiments}
\input{chapters/experiments/part4_experiments}

\part{Applications and Outlook}\label{part:applications}
\input{chapters/applications/part5_applications}
