...
%==============================================================================
\begin{align}
  [\hat{x}^i, \hat{p}_j] &= \imag \hbar \delta^i_j, \label{eq:commutator:canonical} \\
  [\hat{x}^i, \hat{x}^j] &= 0, \label{eq:prelim:commutator-xx} \\
  [\hat{p}_i, \hat{p}_j] &= 0 \label{eq:prelim:commutator-pp}
  \eqtag{M}{QM}{T}
\end{align}
% Notes:
