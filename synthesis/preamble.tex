...
% ENCODING AND FONTS
%------------------------------------------------------------------------------
% Use fontspec for LuaLaTeX/XeLaTeX (Unicode engines), fontenc for pdfLaTeX
\usepackage{iftex}
\ifPDFTeX
  \usepackage[utf8]{inputenc}         % UTF-8 input encoding (pdflatex only)
  \usepackage[T1]{fontenc}            % T1 font encoding (pdflatex only)
  \usepackage{lmodern}                % Latin Modern fonts
\else
  \usepackage{fontspec}               % Modern font selection (LuaLaTeX/XeLaTeX)
  \setmainfont{Latin Modern Roman}    % Use Latin Modern for consistency
\fi
...
% (iftex already loaded in ENCODING AND FONTS section)
\ifPDFTeX
